...
$metadescription = "Moth Design is a graphic and web design based in Boston MA";
$metakeywords = "moth design, graphic design, web design, boston ma";
$bodyclass = "studio";
$pagetitle = "Studio";
$level1 = "studio";
$level2 = ""; 
...
<div class="bg-image studio0"></div>
<div class="bg-image2 top"><img src="images/studio/studio-main2.jpg" width="600" height="300" alt="Moth Design Studio"></div>
...
<div class="whatwedo">
  <div class="wrap">
    ...
    <div class="text-block">
      <h1>A Smart Suite</h1>
      <h2><span>The Essentials</span></h2>
      <p>We have a holistic view of design, but we’re ever-mindful of the core tenets of the studio. They anchor our practice.</p>
    </div> <!-- /project -->

    <div class="studio-col2">
      <div class="icon-bulb"></div>
      <div class="desc">
        <h3>Discovery &amp; Strategy</h3>
        Great design solutions come from an understanding of you and your audience. We unearth the truths of your mission through meaningful user research.
      </div>
    </div>
  
    <div class="studio-col2 last">
      <div class="icon-eye"></div>
      <div class="desc">
        <h3>Branding &amp; Identity</h3>
        Memorable brands are authentic. We’ll help shape your visual vocabulary and an identity that will resonate in the long run.
      </div>
    </div>

    <div class="studio-pad"></div>

    <div class="studio-col2">
      <div class="icon-web"></div>
      <div class="desc">
        <h3>Website Design</h3>
        We specialize in responsive, standards-compliant websites and advanced web applications that are both stylish and accessible.
      </div>
    </div>
    ...
    <div class="studio-col2 last">
      ...
      <div class="desc">
        <h3>Print Design</h3>
        As it turns out, print isn’t dead. We understand when and how to incorporate strong print statements into your overall communications strategy.
      </div>
    </div>
